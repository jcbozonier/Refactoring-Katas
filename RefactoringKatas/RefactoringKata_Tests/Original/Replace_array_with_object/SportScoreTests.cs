...
using RefactoringKata_Tests.Original.Replace_array_with_object.ObjectsCreatedForTesting;
using RefactoringKatas.Original.Replace_array_with_object;

namespace RefactoringKata_Tests.Original.Replace_array_with_object
{
